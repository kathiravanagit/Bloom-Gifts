  ...
  root.innerHTML = `
    <div class="confirm-box">
      ...
      <div class="confirm-detail-card">
        <h4>Items</h4>
        ${itemsHTML}
        <div class="summary-row total" style="margin-top:14px;"><span>Total</span><span>${order.total_amount ? formatMoney(order.total_amount) : 'To be confirmed by shop'}</span></div>
      </div>
